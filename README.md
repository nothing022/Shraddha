...
<h1 align="center">🎵 Shraddha Music Bot 🎵</h1>
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/Surendra9123/ShraddhaBot.git && cd ShraddhaBot
   ```
...
| `/msettings`            | change playmode settings in groups.         |


For a full list of commands, use `/help` in [telegram](https://telegram.me/mnrobot).
...
<p align="center">
  <a href="https://telegram.me/ShraddhaChat">
