...
from ShraddhaMusic.utils.database import add_gban_user, remove_gban_user
...
@app.on_message(filters.command(["mblock"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["munblock"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["mblocked", "mblockedusers", "mblusers"]) & SUDOERS)
@language
