...
async def gen_thumb(videoid: str):
    if not config.PHOTO_THUMBNAIL:
      return None #Telegram issues with uploading photos #slow down bots...
    try:
        ...
        arial = ImageFont.truetype("ShraddhaMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("ShraddhaMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("ShraddhaMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("ShraddhaMusic/assets/play_icons.png")
